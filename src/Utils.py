...
class Utilities:
    distMethod = "levehnstein"
    def setDistMethod(method = "levehnstein"):
        distMethod = method

    def distance(token1, token2, method = "levehnstein"):
        if method == "levehnstein":
            return levenshteinDistanceDP(token1, token2)
        elif method == "jaccard":
            return jaccard_distance(token1, token2)
        elif method == "jaro":
            return jaro_distance(token1, token2)
